...
import com.happyfaceapp.activities.CartActivity;
import com.happyfaceapp.activities.LogInActivity;
import com.happyfaceapp.adapters.AdditionsAdapter;
import com.happyfaceapp.adapters.CoversAdapter;
import com.happyfaceapp.helpers.CallbackRetrofit;
import com.happyfaceapp.helpers.Loading;
import com.happyfaceapp.helpers.PrefManager;
import com.happyfaceapp.helpers.RetrofitModel;
import com.happyfaceapp.helpers.StaticMembers;
import com.happyfaceapp.models.cart.AddCartResponse;
import com.happyfaceapp.models.cart.CartItem;
import com.happyfaceapp.models.cart.GiftAdditionalItem;
...
import com.happyfaceapp.models.gifts.covers.DataItem;
import com.happyfaceapp.models.gifts.messages.MessageInput;
...
public class GiftsFragment extends DialogFragment {
    ...
    private List<com.happyfaceapp.models.gifts.additional.DataItem> additionals;
...
//                Glide.with(Objects.requireNonNull(getActivity())).load(product.getProduct().getLogo()).into(image);
        ...
        additionsAdapter = new AdditionsAdapter(getContext(), additionals, pos -> {
            float total = 0;
            for (com.happyfaceapp.models.gifts.additional.DataItem add : additionals) {
                if (add.isSelected()) {
...
//            stringBuilder.append(getString(R.string.cover_id)+" "+messageInput1.getCoverId()).append("\n");
    ...
    private void changeCartItem() {
        ...
        if (PrefManager.getInstance(getContext()).getAPIToken().isEmpty()) {
            ...
            for (com.happyfaceapp.models.gifts.additional.DataItem addition : additionals) {
                ...
                if (loading!=null&&loading.isShowing()){
                    ...
                    for (int i = 0; i < additionals.size(); i++) {
                        if (product != null && (product.getGiftAdditional() != null)) {
                            com.happyfaceapp.models.gifts.additional.DataItem additional = additionals.get(i);
